...
@section('content')
    ...
    <div class="card">
        <div class="d-flex align-items-center justify-content-between mb-2">
            ...
            <a href="{{route('video-reportages.create')}}" type="button" class="btn btn-primary waves-effect waves-light">Добавить</a>
        </div>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" style="">
                                        <a class="dropdown-item" href="{{route('video-reportages.edit', $item->id)}}"><i class="icon-base bx bx-edit-alt me-1"></i>Изменить</a>
                                        <form action="{{route('video-reportages.destroy', $item->id)}}" method="post">
                                            @csrf
                                            @method('delete')
