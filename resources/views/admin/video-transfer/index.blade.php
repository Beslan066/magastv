...
@section('content')
    ...
    <div class="card">
        <div class="d-flex align-items-center justify-content-between mb-2">
            ...
            <a href="{{route('video-transfers.create')}}" type="button" class="btn btn-primary waves-effect waves-light">Добавить</a>
        </div>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" style="">
                                        <a class="dropdown-item" href="{{route('video-transfers.edit', $item->id)}}"><i class="icon-base bx bx-edit-alt me-1"></i>Изменить</a>
                                        <form action="{{route('video-transfers.destroy', $item->id)}}" method="post">
                                            @csrf
                                            @method('delete')
