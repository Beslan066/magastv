...
@section('content')
    <div class="card">
        <div class="d-flex justify-content-between align-items-center">
            <h4 class="card-header">Создание пользователя</h4>
        </div>
        ...
        <form action="{{route('users.store')}}" method="post">
            ...
            <div class="card-body">
                <div class="mb-4 w-50">
                    <input type="text" class="form-control" id="basic-default-fullname" placeholder="ФИО" name="name">
                </div>
                ...
                <div class="input-group mb-4 w-50">
                    <select class="form-select" id="inputGroupSelect02" name="role_id">
                        <option value="">Выберите роль...</option> <!-- Добавьте value="" -->
