                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="mb-4">
                                ...
                                <div class="mb-4 mt-2">
                                    <div class="input-group">
                                        <input type="text" class="form-control" placeholder="Автор изображения" name="image_author" value="{{$news->image_author}}">
                                    </div>
                                    <div class="input-group mt-2">
                                        <textarea class="form-control" placeholder="Описание изображения" name="image_description">{{$news->image_description}}</textarea>
                                    </div>
                                </div>
