...
@section('content')
    ...
    <div class="card">
        <div class="d-flex align-items-center justify-content-between mb-2">
            ...
            <a href="{{route('radio-broadcast.create')}}" type="button" class="btn btn-primary waves-effect waves-light">Добавить</a>
        </div>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" style="">
                                        <a class="dropdown-item" href="{{route('radio-broadcast.edit', $item->id)}}"><i class="icon-base bx bx-edit-alt me-1"></i>Изменить</a>
                                        <form action="{{route('radio-broadcast.destroy', $item->id)}}" method="post">
                                            @csrf
                                            @method('delete')
