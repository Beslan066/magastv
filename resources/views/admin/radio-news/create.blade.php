...
@section('content')
    ...
    <div class="card">
        <div class="d-flex justify-content-between align-items-center">
            <h4 class="card-header">Создание анонса</h4>
        </div>

        <form action="{{route('radio-news.store')}}" method="post" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="col-xl">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mb-4">
                                    <div class="input-group">
                                        <textarea class="form-control" placeholder="В эфире" name="in_air"></textarea>
                                    </div>
                                </div>
