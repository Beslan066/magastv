    ...
    <div class="card">
        ...
        <form action="{{route('about.update', $about->id)}}" method="post" enctype="multipart/form-data">
            ...
            <div class="row mb-6 gy-6">
                        ...
                        <div class="card-body">
                            <div class="mb-4">
                                <div class="input-group">
                                    <textarea class="form-control" placeholder="Лид" name="lead">{{$about->lead}}</textarea>
                                </div>
                            </div>
                ...
                <div class="col-xl">
                    <div class="card">
                        <div class="card-body">
                            <div class="mb-4">
                                <div class="input-group">
                                    <input type="file" class="form-control" id="inputGroupFile02" name="image" accept="image/*" @if($about->image)
                                        data-default-file="{{ asset('storage/public/' . $about->image) }}"
                                           @endif>
                                ...
                                <div class="old-image-wrapper mt-3 position-relative">
                                    ...
                                    <img src="{{asset('storage/public/' . $about->image)}}" class="img-thumbnail old-image-preview" style="max-height: 200px">
                                </div>
                                @endif
                ...
                <div class="ml-2 mb-2">
                    <a href="{{route('about.index')}}" class="btn btn-secondary">Отмена</a>
