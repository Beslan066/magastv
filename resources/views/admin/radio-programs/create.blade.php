...
@section('content')
    ...
    <div class="card">
        <div class="d-flex justify-content-between align-items-center">
            <h4 class="card-header">Добавление программы радио</h4>
        </div>

        <form action="{{ route('radio-programs.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="ml-2 mb-2">
                <a href="{{ route('radio-programs.index') }}" class="btn btn-secondary">Отмена</a>
