...
@section('content')
    <div class="card">
        <div class="d-flex align-items-center justify-content-between mb-2">
            ...
            <div class="d-flex">
                <form action="{{ route('radio-programs.index') }}" method="GET" class="d-flex">
                    <input
                        type="date"
                        name="date"
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="{{ route('radio-programs.edit', $program->id) }}">
                                        <i class="icon-base bx bx-edit-alt me-1"></i>Изменить
                                    </a>
                                    <form action="{{ route('radio-programs.destroy', $program->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
...
<script>
    document.getElementById('date-filter').addEventListener('change', function() {
        ...
        window.location.href = "{{ route('radio-programs.index') }}?date=" + date;
    });
</script>
