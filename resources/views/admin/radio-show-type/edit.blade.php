...
@section('content')
    <div class="card">
        ...
        <form action="{{route('radio-show-type.update', $radioShowType->id)}}" method="post">
            @csrf
            @method('patch')

            <div class="card-body">
                <div class="mb-4 w-50">
                    <input type="text" class="form-control" id="basic-default-fullname" placeholder="Заголовок" name="title" value="{{$radioShowType->title}}">
                </div>
