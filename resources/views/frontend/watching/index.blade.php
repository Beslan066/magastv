...
@push('meta')
    <title>Где смотреть - НТРК "Магас"</title>
@endpush
                    ...
                    <div class="watch__list-wrapper">
                        <ul class="list-reset watch__list">
                            ...
                            <li class="watch__item">
                                <div class="watch__item_top">
                                    <div class="watch__item_image">
                                        <img src="{{asset('assets/img/watch/rtrt.webp')}}" alt="Триколор">
                                    </div>
                                    <h6 class="watch__item_title" style="cursor: pointer;" title="Технология HBBTV.  Платформа РТРС.ПЛЮС  PLUS.RTRS.RU  Регион «Республика Ингушетия».  Регион выбирается во вкладке «Настройки». Телеканал во вкладке «Местное ТВ», на территории Республики Ингушетия номер канала «999».">Телерадиоканалы на РТРС.ПЛЮС</h6>
                                </div>
                                <div class="watch__item_bottom">

                                    <a style="cursor: pointer;" title="Технология HBBTV.  Платформа РТРС.ПЛЮС  PLUS.RTRS.RU  Регион «Республика Ингушетия».  Регион выбирается во вкладке «Настройки». Телеканал во вкладке «Местное ТВ», на территории Республики Ингушетия номер канала «999».">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                             xmlns="http://www.w3.org/2000/svg">
                                            <rect x="18.6567" y="12.4141" width="13" height="10" rx="2"
                                                  transform="rotate(135 18.6567 12.4141)" stroke="#1A1A1A"
