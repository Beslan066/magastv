                ...
                <div class="radio__content_inner">
                    <div class="radio__content_left">
                        ...
                        <div class="radio-events">
                            ...
                            <div class="main-transfers__header" style="margin-top: 20px">
                            ...
                            <div class="main-transfers__header" style="margin-top: 40px">
                                <h2 class="radio-events__title">
                                    Аудиокниги
                                </h2>
                                <a href="{{route('radio.books')}}" class="main-transfers__all">Все книги</a>
                            </div>
                                        ...
                                        <div class="player__controls">
                                            ...
                                            <div class="player__volume">
                                                <button class="btn-reset player__mute">
                                                    ...
                                                    <svg
                                                    class="player__mute-muteSvg" width="18" height="16" viewBox="0 0 18 16" fill="none"
                                                         xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <svg width="19" height="16" viewBox="0 0 19 16" fill="none" xmlns="http://www.w3.org/2000/svg" class="player__mute-unmuteSvg">
