                    ...
                    <div class="live-content">
                        <div class="live-content__left">
                             <div class="live__main-media">
                                    <!-- <iframe class="header__media_video" src="https://public.mediacdn.ru/magas/" frameborder="0" allowfullscreen allow="autoplay; fullscreen; picture-in-picture;"></iframe> -->
                                    <video id="live__main-media--video" class="live__main-media--video" controls="false" autoplay="true" preload="true"></video>
                                 <div class="main-media__navigation-bar">
                                    <div class="navigation-bar__left">
                                        <button class="btn-reset main-media__play hidden">
                                        ...
                                        <button class="btn-reset main-media__pause">
                                    ...
                                    <svg  width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        ...
                                        <button class="btn-reset main-media__mute muted">
...
<script defer src="{{asset('js/live.page.js')}}" type="module"></script>
@endpush
