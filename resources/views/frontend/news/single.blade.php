                        ...
                        <div class="single-news__content">
                            <div class="single-news__content--main">
                                ...
                                @if($news->preview)
                                    <div class="single-news__image single-news__image--main">
                                        <div class="single-news__image_content" style="margin-bottom: 10px">
                                            <img src="{{asset('storage/public/' . $news->preview)}}" alt="{{$news->title}}">
                                        </div>
                                    </div>
                                @endif
                                    ...
                                    <ul class="list-reset popular-sidebar__list">
                                        @if($popularItems)
                                            @foreach($popularItems as $popularItem)
                                                <li class="popular-sidebar__item">
                                                    <a href="{{route('home.news.single', $popularItem->slug)}}" class="popular-sidebar__item_text">
                                                        {{$popularItem->title}}
                                                    </a>
                                                    <div class="popular-sidebar__item_info">
                                                        <time datetime="{{$popularItem->formatted_published_at}}" class="popular-sidebar__item_time">
