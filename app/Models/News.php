...
class News extends Model
{
    ...
    // Указываем, что для связывания маршрута нужно использовать поле slug
    ...
    {
        $this->timestamps = false; // чтобы не обновлять updated_at
        $this->increment('views');
        $this->timestamps = true;
    }

    /**
     * Форматирует дату в виде "27 мар, 23:53" (если текущий год) или "27 мар 2023, 23:53" (если прошлый год)
     */
